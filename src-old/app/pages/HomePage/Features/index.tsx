    ...
    return (
        <>
            ...
            <Lead>
                ...
                <strong>highly performant</strong> React.js applications with a
                focus on <strong>best DX</strong> and{' '}
            ...
            <List>
                <Feature>
                    ...
                    <Content>
                        ...
                        <P>
                            Build easy to test and debug, flexible and
                            extensible applications using{' '}
                            <A
                            ...
                            to see how your application's state changes and
                            travel in time to debug. Type any github username
                            below and see it in action with Redux Dev Tools.
                        </P>
                        <GithubRepoForm />
                    </Content>
                </Feature>
                <Feature>
                    ...
                    <Content>
                        ...
                        <P>
                            Write composable CSS that’s co-located with your
                            components for complete modularity. Ship only the
                            styles that are on the page for the best
                            performance. Generate application-wide styles and
                            themes for your components. Change the theme below
                            to see how easy and intuitive theming can ever be!
                        </P>
                        <ThemeSwitch />
                    </Content>
                </Feature>
                <Feature>
                    ...
                    <Content>
                        ...
                        <P>
                            ...
                            <br />
                            <small>
                                (Only some of the features below are translated
                ...
                <Feature>
                    ...
                    <Content>
                        ...
                        <P>
                            ...
                            <small>
                                Go to our{' '}
                                <Link to={process.env.PUBLIC_URL + '/notfound'}>
                                    /NotFound
                                </Link>{' '}
                ...
                <Feature>
                    ...
                    <Content>
                        ...
                        <P>
                            Supports SEO (document head tags management) for
                            search engines that support indexing of JavaScript
                            content.
                        </P>
                    </Content>
                </Feature>
                <Feature>
                    ...
                    <Content>
                        ...
                        <P>
                            Typescript is the key to scalability. Build
                            self-documented code, easy-to-debug code and create
                            maintainable large applications and codebases with a
                ...
                <Feature>
                    ...
                    <Content>
                        ...
                        <P>
                            Focus on writing new features without worrying about
                            formatting or code quality. With the right editor
                            setup, your code will automatically be formatted and
                            linted as you work.
                        </P>
                    </Content>
                </Feature>
